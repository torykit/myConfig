# base software
yum install -y vim epel-release gcc mlocate htop rsync bash-completion yum-fastestmirror lrzsz vim mlocate iproute iftop autojump bind-utils lm_sensors 
